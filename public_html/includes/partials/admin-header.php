...
<div class="app-layout">
    ...
    <aside class="app-sidebar" id="appSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/admin/members.php" class="nav-link <?= $activeMenu === 'members' ? 'active' : '' ?>">
            ...
            <a href="/admin/membership-setup.php" class="nav-link <?= $activeMenu === 'membership' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Membership
            </a>
            <?php endif; ?>

            <?php if (admin_can($currentUserId, 'payments', 'view')): ?>
            <a href="/admin/payments.php" class="nav-link <?= $activeMenu === 'payments' ? 'active' : '' ?>">
            ...
            <a href="/admin/donations.php" class="nav-link <?= $activeMenu === 'donations' ? 'active' : '' ?>">
            ...
            <div class="nav-group-title">Content &amp; Documents</div>

            <?php if (admin_can($currentUserId, 'news', 'view')): ?>
            <a href="/admin/news.php" class="nav-link <?= $activeMenu === 'news' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                News
            </a>
            <?php endif; ?>

            <?php if (admin_can($currentUserId, 'orders', 'view')): ?>
            <a href="/admin/orders.php" class="nav-link <?= $activeMenu === 'orders' ? 'active' : '' ?>">
            ...
            <a href="/admin/circulars.php" class="nav-link <?= $activeMenu === 'circulars' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/></svg>
                Circulars
            </a>
            <?php endif; ?>

            <?php if (admin_can($currentUserId, 'documents', 'view')): ?>
            <a href="/admin/documents.php" class="nav-link <?= $activeMenu === 'documents' ? 'active' : '' ?>">
            ...
            <a href="/admin/activities.php" class="nav-link <?= $activeMenu === 'activities' ? 'active' : '' ?>">
            ...
            <a href="/admin/events.php" class="nav-link <?= $activeMenu === 'events' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Events
            </a>
            <?php endif; ?>
            ...
            <a href="/admin/meetings.php" class="nav-link <?= $activeMenu === 'meetings' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                Meetings
            </a>
            <?php endif; ?>

            <div class="nav-group-title">Association &amp; System</div>
            ...
            <a href="/admin/members-reports.php" class="nav-link <?= $activeMenu === 'reports' ? 'active' : '' ?>">
            ...
            <a href="/admin/users.php" class="nav-link <?= $activeMenu === 'users' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                Users/Roles
            </a>
            <?php endif; ?>
            ...
            <a href="/admin/audit-logs.php" class="nav-link <?= $activeMenu === 'audit_logs' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                Audit Logs
            </a>
            <?php endif; ?>

            <?php if (admin_can($currentUserId, 'settings', 'view')): ?>
            <a href="/admin/settings.php" class="nav-link <?= $activeMenu === 'settings' ? 'active' : '' ?>">
