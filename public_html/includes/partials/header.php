...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .header-nav-strip {
            background: linear-gradient(180deg, #E1EBF5 0%, #CDDFEE 100%);
        ...
        nav.main-nav a.nav-link:hover {
            background: #ffffff;
            color: var(--prof-blue);
            box-shadow: 0 1px 4px rgba(16, 49, 84, 0.12);
        }
        nav.main-nav a.nav-link.active {
            color: var(--prof-blue);
            font-weight: 700;
            background: rgba(255, 255, 255, 0.85);
            box-shadow: 0 1px 3px rgba(16, 49, 84, 0.08);
        }
                ...
                <details class="nav-dropdown">
                    ...
                    <div class="nav-dropdown-menu">
                        ...
                        <a href="/member-login.php">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
                            <span>Activate / Check Status</span>
                        </a>
